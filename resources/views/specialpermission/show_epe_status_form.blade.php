...
{{ Form::open(array('role' => 'form', 'url' => '#', 'class' => 'form-horizontal form-row-seperated', 'id' => 'specialPermissionEpeForm')) }}
...
<div class="modal-footer" style="background-color: #f5f5f5;border-top: 1px solid #e7ecf1;">
    <button type="button" class="btn btn-circle green" id="saveEpeSpecialPermission"><i class="fa fa-check"></i> {{trans('english.SUBMIT')}}</button>
...
{{ Form::hidden('epe_id', $epeInfoObj->id, array('id' => 'taeId')) }}
{{ Form::close() }}
