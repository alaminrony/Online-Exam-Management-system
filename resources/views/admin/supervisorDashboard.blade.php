    ...
    <div class="row margin-bottom-20">
        ...
        <div class="col-md-12">
            <div class="row margin-top-15">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 blue-soft" href="{!! URL::to('examResultReport') !!}">
                        <div class="visual col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 green-sharp" href="{!! URL::to('mockTestReport') !!}">
                        <div class="visual col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <i class="icon-note"></i>
                        </div>
                        <div class="details col-lg-8 col-md-8 col-sm-8 col-xs-8">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 purple" href="{!! URL::to('employeeWiseResult') !!}">
                        <div class="visual col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <i class="icon-equalizer"></i>
                        </div>
                        <div class="details col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="desc"> @lang('label.EMPLOYEE_WISE_RESULT') </div>
                        </div>
                    </a>
                </div>
            </div>
