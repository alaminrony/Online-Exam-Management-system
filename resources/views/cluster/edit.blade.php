...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.EDIT_CLUSTER')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('cluster.update', $target->id), 'method' => 'PATCH','class' => 'form-horizontal'] ) !!}
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="short_name">@lang('label.SHORT_NAME') :<span class="text-danger"> *</span></label>
                            <div class="col-md-8">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/cluster'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
