...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-graduation-cap"></i>@lang('label.MANAGE_EPE') </div>
            <div class="tools">
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group">
                            <label class="col-md-4 control-label">@lang('label.SELECT_SUBJECT') :<span class="required"> *</span></label>
                            <div class="col-md-8">
                                {{ Form::hidden('subject_id', ($epeObjArr) ? $epeObjArr->subject_id : null, array('id' => 'epeSubjectIdHidden')) }}
                                {{Form::select('subject_id', $subjectList, ($epeObjArr) ? $epeObjArr->subject_id : null, array('class' => 'form-control js-source-states', 'id' => 'epeSubjectId', 'disabled' => 'true'))}}
                        ...
                        <div id="showEpe">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>@lang('label.SELECT_TYPE_QUESTIONS') :</strong></label>
                                <div class="col-md-7">
                                    <table>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        {{Form::select('questionnaire_format', $qusFormatList, ($epeObjArr) ? $epeObjArr->questionnaire_format: null, array('class' => 'form-control js-source-states', 'id' => 'questionnaireFormat'))}}
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <button type="submit" class="btn btn-circle green" id="epeSubmit"><i class="fa fa-save"></i> @lang('label.SAVE')</button>
                            <a href="{{URL::to('epe')}}">
