...
<html>
    ...
    <body>
         <div class="header">
            ...
            <div class="logoTile">
                <span>@lang('label.CLUSTER_RESULT')</span>
            </div>
        ...
        <div class="row">
            <div class="text-center">
                <label><b>@lang('label.CLUSTER'):</b> {{$clusterList[$request->cluster_id] > '0' ? $clusterList[$request->cluster_id] : 'N/A'}}</label>
        ...
        <table>
            <tr>
                <td>
                    <label>@lang('label.CLUSTER'): {{$clusterList[$request->cluster_id] > '0' ? $clusterList[$request->cluster_id] : 'N/A'}}</label>
