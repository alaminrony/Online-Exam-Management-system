...
<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="logoTile">
                <span>@lang('label.BRANCH_RESULT')</span>
            </div>
        ...
        <div class="row">
            <div class="text-center">
                <label><b>@lang('label.BRANCH'):</b> {{!empty($branchList[$request->branch_id])? $branchList[$request->branch_id] : 'N/A'}}</label>
        ...
        <table>
            <tr>
                <td>
                    <label>@lang('label.BRANCH'): {{$branchList[$request->branch_id] > '0' ? $branchList[$request->branch_id] : 'N/A'}}</label>
