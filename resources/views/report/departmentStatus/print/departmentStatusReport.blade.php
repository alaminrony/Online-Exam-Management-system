...
<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="logoTile">
                <span>@lang('label.DEPARTMENT_STATUS')</span>
            </div>
        ...
        <div class="row">
            <div class="text-center">
                <label><b>@lang('label.DEPARTMENT'):</b> {{!empty($departmentList[$request->department_id]) ? $departmentList[$request->department_id] : 'N/A'}}</label>
        ...
        <table>
            <tr>
                <td>
                    <label>@lang('label.DEPARTMENT'): {{!empty($departmentList[$request->department_id]) ? $departmentList[$request->department_id] : 'N/A'}}</label>
