...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i>@lang('label.FORCE_CHANGE_PASSWORD') 
            </div>
            <div class="tools">
            </div>
        </div>
        <div class="portlet-body form">
                        ...
                        <tr>
                            <td>
                                <address class="text-left">
                                    ...
                                    <strong>@lang('label.RANK'): </strong>{{$userInfo->rank->title ?? ''}}<br />
            ...
            <!-- BEGIN FORM-->
            {{ Form::open(array('group' => 'form', 'url' => 'updateForcePassword/'.$userInfo->id, 'class' => 'form-horizontal', 'id'=>'forcePassword')) }}
