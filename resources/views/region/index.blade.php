...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.REGION_LIST')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('region/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_REGION')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'region/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    ...
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('region/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    
                                    {{ Form::open(array('url' => 'region/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline')) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_REGION_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
