...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-suitcase"></i>@lang('label.UPDATE_APPOINTMENT') </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {{ Form::model($appointment, array('route' => array('designation.update', $appointment->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'appointmentUpdate')) }}
            {{csrf_field()}}
