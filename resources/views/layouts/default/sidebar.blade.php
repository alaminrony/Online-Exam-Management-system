...
<div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul id="addsidebarFullMenu" class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" >
            ...
            <li <?php $current = ( in_array($currentControllerName, array('dashboard'))) ? 'start active open' : ''; ?>class="nav-item {{$current}} nav-item ">
            ...
            <li class="nav-item <?php echo ($currentControllerName == 'gallery') ? 'start active open' : ''; ?>">
                <a href="{{URL::to('gallery')}}"  class="nav-link nav-toggle">
                    <i class="fa fa-file-image-o"></i>
                    <span class="title">@lang('label.PHOTO_GALLERY')</span>
            ...
            ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">@lang('label.GENERAL_SETUP')</span>
                    <span class="selected"></span>
...
<!--                            <i class="fa fa-book"></i>-->
            ...
            <li class="nav-item <?php echo (in_array($currentControllerName, array('usergroup', 'user'))) ? 'start active open' : ''; ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title"> @lang('label.USER_MANAGEMENT')</span>
                    <span class="selected"></span>
                    <span class="arrow open"></span>
                </a>
                <ul class="sub-menu">
            ...
            <li class="nav-item <?php echo (in_array($currentControllerName, array('configuration', 'signatory', 'scrollmessage', 'passwordsetup'))) ? 'start active open' : ''; ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">@lang('label.SETTING')</span>
                    <span class="selected"></span>
                    <span class="arrow open"></span>
                </a>
                <ul class="sub-menu">
<!--                    <li class="nav-item <?php echo ($currentControllerName == 'signatory') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('signatory')}}" class="nav-link ">
                            <span class="title">@lang('label.SIGNATORY')</span>
                        </a>
                    </li>-->
                    <li class="nav-item <?php echo ($currentControllerName == 'configuration') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('configuration')}}" class="nav-link ">
                    ...
                    <li class="nav-item <?php echo ($currentControllerName == 'scrollmessage') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('scrollmessage')}}" class="nav-link ">
                            <span class="title">@lang('label.SCROLL_MESSAGE')</span>
                        </a>
                    </li>

                    <li class="nav-item <?php echo ($currentControllerName == 'passwordsetup') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('passwordSetup')}}" class="nav-link ">
                            <span class="title">@lang('label.PASSWORD_SETUP')</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <!--<li class="nav-item <?php echo ($currentControllerName == 'student') ? 'start active open' : ''; ?>">
                <a href="{{URL::to('student/student_profile/'.Auth::user()->id)}}"  class="nav-link nav-toggle">
                    <i class="icon-user"></i>
            ...
            <li class="nav-item <?php echo (in_array($currentControllerName, array('marksdistribution', 'subjecttods', 'subjecttoci')) || in_array($routeName, array('part/course', 'part/phase'))) ? 'start active open' : ''; ?>">
                ...
                <ul class="sub-menu">
                    <li class="nav-item <?php echo ($currentControllerName == 'subjecttods') ? 'start active open' : ''; ?>"">
                        <a href="{{URL::to('subjecttods')}}" class="nav-link ">
                            <span class="title">@lang('label.ASSIGN_SUBJECT_TO_EXAMINER')</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">@lang('label.EXAM_MANAGEMENT')</span>
                    <span class="selected"></span>
                    <span class="arrow open"></span>
                </a>
                <ul class="sub-menu">
                    @if(in_array(Auth::user()->group_id,[1]) && Auth::user()->first_login =='1')
                    <li class="nav-item <?php echo ($currentControllerName == 'question') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('question')}}"  class="nav-link nav-toggle">
                            <i class="icon-tag"></i>
                            <span class="title">@lang('label.QUESTION_BANK')</span>
                            <span class="selected"></span>
                        </a>
                    </li>

                    <li class="nav-item <?php echo ($currentControllerName == 'mocktest') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('mock_test')}}"  class="nav-link nav-toggle">
                            <i class="fa fa-filter"></i>
                            <span class="title">@lang('label.EPE_MOCK_TEST')</span>
                            <span class="selected"></span>
                        </a>
                    </li>
                    <li class="nav-item <?php echo ($currentControllerName == 'epe') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('epe')}}"  class="nav-link nav-toggle">
                            <i class="icon-note"></i>
                            <span class="title">@lang('label.EXAM')</span>
                            <span class="selected"></span>
                        </a>
                    </li>
                    <li class="nav-item <?php echo ($currentControllerName == 'examtostudent') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('examtostudent')}}"  class="nav-link nav-toggle">
                            <i class="icon-equalizer"></i>
                            <span class="title">@lang('label.ASSIGN_EXAM_TO_EMPLOYEE')</span>
                            <span class="selected"></span>
                        </a>
                    </li>
                    <li class="nav-item <?php echo ($currentControllerName == 'epeattendee') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('epeattendee')}}"  class="nav-link nav-toggle">
                            <i class="fa fa-child"></i>
                            <span class="title">@lang('label.EPE_ATTENDEE')</span>
                            <span class="selected"></span>
                        </a>
                    </li>
                    @if(in_array(Auth::user()->group_id,[1]))
                    <li class="nav-item <?php echo ($currentControllerName == 'unlockrequestci') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('unlockrequest')}}"  class="nav-link nav-toggle">
                            <i class="fa fa-unlock"></i>
                            <span class="title">@lang('label.EPE_UNLOCK_REQUEST')</span>
                            <span class="selected"></span>
                        </a>
                    </li>
                    @endif
            ...
            @endif
            @if(in_array(Auth::user()->group_id,[2]) && Auth::user()->first_login =='1')
            <li class="nav-item <?php echo ($currentControllerName == 'epedsmarking') ? 'start active open' : ''; ?>">
                <a href="{{URL::to('epedsmarking')}}"  class="nav-link nav-toggle">
                    <i class="fa fa-book"></i>
                    <span class="title">@lang('label.EPE_MARKING_SUB')</span>
                    <span class="selected"></span>
                </a>
            </li>
            @endif

            @if(Auth::user()->group_id == '3' && Auth::user()->first_login =='1')
            <li class="nav-item <?php echo ($routeName == 'isspstudentactivity/myepe') ? 'start active open' : ''; ?>">
                <a href="{{URL::to('isspstudentactivity/myepe')}}"  class="nav-link nav-toggle">
                    <i class="icon-note"></i>
                    <span class="title">@lang('label.MY_EPE')</span>
                    <span class="selected"></span>
                </a>
            </li>
            @endif
            ...
            <li class="nav-item <?php echo ($routeName == 'isspstudentactivity/mymocktest') ? 'start active open' : ''; ?>">
                <a href="{{URL::to('isspstudentactivity/mymocktest')}}"  class="nav-link nav-toggle">
                    <i class="fa fa-filter"></i>
                    <span class="title">@lang('label.EPE_MOCK_TEST')</span>
                    <span class="selected"></span>
                </a>
            ...
            @if(in_array(Auth::user()->group_id,[1,2,3,4]) && Auth::user()->first_login =='1')
            <li class="nav-item <?php echo (in_array($currentControllerName, array('gradingsystem', 'examresultreport', 'mocktestreport', 'employeewiseresult'))) ? 'start active open' : ''; ?>">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item <?php echo ($currentControllerName == 'gradingsystem') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('gradingSystem')}}" class="nav-link ">
                    ...
                    <li class="nav-item <?php echo ($currentControllerName == 'examresultreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('examResultReport')}}" class="nav-link">
                            <span class="title">@lang('label.EXAM_RESULT')</span>
                        </a>
                    </li>
                    @endif
                    @if(in_array(Auth::user()->group_id,[1,2,3,4]) && Auth::user()->first_login =='1')
                    <li class="nav-item <?php echo ($currentControllerName == 'mocktestreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('mockTestReport')}}" class="nav-link">
                            <span class="title">@lang('label.MOCK_TEST_RESULT')</span>
                        </a>
                    </li>
                    @endif
                    @if(in_array(Auth::user()->group_id,[1,2,3,4]) && Auth::user()->first_login =='1')
                    <li class="nav-item <?php echo ($currentControllerName == 'employeewiseresult') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('employeeWiseResult')}}" class="nav-link">
                            <span class="title">@lang('label.EMPLOYEE_WISE_RESULT')</span>
                        </a>
                    </li>
                    @endif
                </ul>
            ...
            @endif
            @if(in_array(Auth::user()->group_id,[1,2,4]) && Auth::user()->first_login =='1')
            <li class="nav-item <?php echo (in_array($currentControllerName, array('regionstatusreport', 'branchresult', 'stafftrendanalysis', 'clusterresultreport', 'departmentstatusreport', 'participationstatus'))) ? 'start active open' : ''; ?>">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item <?php echo ($currentControllerName == 'regionstatusreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('regionStatusReport')}}" class="nav-link">
                            <span class="title">@lang('label.REGION_STATUS')</span>
                        </a>
                    </li>
                    @endif
                    @if(in_array(Auth::user()->group_id,[1,2,4]) && Auth::user()->first_login =='1')
                    <li class="nav-item <?php echo ($currentControllerName == 'clusterresultreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('clusterResult')}}" class="nav-link">
                            <span class="title">@lang('label.CLUSTER_RESULT')</span>
                        </a>
                    </li>
                    @endif
                    @if(in_array(Auth::user()->group_id,[1,2,4]) && Auth::user()->first_login =='1')
                    <li class="nav-item <?php echo ($currentControllerName == 'branchresult') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('branchResult')}}" class="nav-link">
                            <span class="title">@lang('label.BRANCH_RESULT')</span>
                        </a>
                    </li>
                    @endif
                    @if(in_array(Auth::user()->group_id,[1,2,4]) && Auth::user()->first_login =='1')
                    <li class="nav-item <?php echo ($currentControllerName == 'departmentstatusreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('departmentStatusReport')}}" class="nav-link">
                            <span class="title">@lang('label.DEPARTMENT_STATUS')</span>
                        </a>
                    </li>
                    @endif
                    @if(in_array(Auth::user()->group_id,[1,2,4]) && Auth::user()->first_login =='1')
                    <li class="nav-item <?php echo ($currentControllerName == 'stafftrendanalysis') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('staffTrendAnalysis')}}" class="nav-link">
                            <span class="title">@lang('label.STAFF_TREND_ANALYSIS')</span>
                        </a>
                    </li>
                    @endif
                    @if(in_array(Auth::user()->group_id,[1,2,4]) && Auth::user()->first_login =='1')
                    <li class="nav-item <?php echo ($currentControllerName == 'participationstatus') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('participationStatus')}}" class="nav-link">
                            <span class="title">@lang('label.PARTICIPATION_STATUS')</span>
                        </a>
                    </li>
                    @endif
            ...
            <li class="nav-item <?php echo (in_array($currentControllerName, array('loginreport', 'userlogreport', 'questionlogreport', 'branchlogreport', 'changepasswordlogreport'))) ? 'start active open' : ''; ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title"> @lang('label.HISTORY_REPORT')</span>
                    <span class="selected"></span>
                    <span class="arrow open"></span>
                </a>
                <ul class="sub-menu">
                    ...
                    <li class="nav-item <?php echo ($currentControllerName == 'loginreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('loginReport')}}" class="nav-link ">
                            <span class="title">@lang('label.LOGIN_REPORT')</span>
                        </a>
                    </li>
                    <li class="nav-item <?php echo ($currentControllerName == 'userlogreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('userLogReport')}}" class="nav-link ">
                    ...
                    <li class="nav-item <?php echo ($currentControllerName == 'changepasswordlogreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('changePasswordLog')}}" class="nav-link ">
                            <span class="title">@lang('label.CHANGE_PASSWORD')</span>
                        </a>
                    </li>
                    <li class="nav-item <?php echo ($currentControllerName == 'questionlogreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('questionLogReport')}}" class="nav-link ">
                            <span class="title">@lang('label.QUESTION')</span>
                        </a>
                    </li>
                    <li class="nav-item <?php echo ($currentControllerName == 'branchlogreport') ? 'start active open' : ''; ?>">
                        <a href="{{URL::to('branchLogReport')}}" class="nav-link ">
