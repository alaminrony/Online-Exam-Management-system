...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i>@lang('label.UPDATE_SCROLL_MESSAGE') </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {{ Form::model($message, array('route' => array('scrollmessage.update', $message->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'messageUpdate')) }}
            {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label class="col-md-4 control-label">@lang('label.SELECT_SCOPE') : <span class="required"> *</span></label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">@lang('label.MESSAGE') :</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                {{Form::select('status', $statusList, Request::get('status'),array('class' => 'form-control js-source-states-hidden-search', 'id' => 'courseStatus'))}}
