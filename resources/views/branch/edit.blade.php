...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cubes"></i>@lang('label.UPDATE_BRANCH') </div>
            <div class="tools">
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            {{ Form::model($target, array('route' => array('branch.update', $target->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'branchUpdate')) }}
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {{Form::select('cluster_id', $clusterList, Request::get('cluster_id'), array('class' => 'form-control js-source-states', 'id' => 'clusterId'))}}
