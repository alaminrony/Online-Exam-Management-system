...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="icon-tag"></i>@lang('label.CREATE_NEW_QUESTION') 
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            {{ Form::open(array('role' => 'form', 'url' => 'question', 'files' => true, 'class' => 'form-horizontal', 'id'=>'questionCreate')) }}
            {{csrf_field()}}
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {{Form::select('subject_id', $subjectArr,!empty($subjectId)?subjectId : Request::get('subject_id'), array('class' => 'form-control js-source-states', 'id' => 'subject_id'))}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {{Form::select('type_id', $typeArr, Request::get('type_id'), array('class' => 'form-control js-source-states', 'id' => 'type_id'))}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-3 mul-ques-radio-btn">
                                        <label class="mt-radio">
                                            {{Form::radio('mcq_answer',$i,false,['class'=>'showCrtAns','data-id'=>$i])}}
                                            <span></span>
                                        </label>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="mt-radio-inline">
                                        <label class="mt-radio">
                                            <input type="radio" name="tf_answer" id="btnTrue" value="1"> @lang('label.TRUE')
                                            <span></span>
                                        </label>
                                        <label class="mt-radio">
                                            <input type="radio" name="tf_answer" id="btnFalse" value="0">@lang('label.FALSE')
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {{Form::select('content_type_id',$contentTypeList, !empty(Request::get('content_type_id')) ? Request::get('content_type_id') : '0', array('class' => 'form-control','id'=>'contentTypeId'))}}
