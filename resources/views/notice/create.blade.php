        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('english.CREATE_NEW_NOTICE')}} </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {{ Form::open(array('role' => 'form', 'url' => 'notice', 'class' => 'form-horizontal', 'id'=>'createNotice','enctype'=>'multipart/form-data')) }}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        {{ Form::text('title', Request::get('title'), array('id'=> 'rankTitle', 'class' => 'form-control', 'placeholder' => 'Enter Notice Title')) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            {{ Form::textarea('short_info', null, ['class' => 'form-control ','size' => '65x5','id'=>'unitShortInfo']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group date date-picker" data-date="{{ date("Y-m-d")}}" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                            ...
                                            {{ Form::text('published_date','', array('id'=> 'publishedDate', 'class' => 'form-control ','readonly' => 'true')) }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group date date-picker" data-date="{{ date("Y-m-d")}}" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                            ...
                                            {{ Form::text('closing_date','', array('id'=> 'closingDate', 'class' => 'form-control ','readonly' => 'true')) }}
                                        </div>
...
<script type="text/javascript">
	$(document).on("submit", '#createNotice', function (e) {
