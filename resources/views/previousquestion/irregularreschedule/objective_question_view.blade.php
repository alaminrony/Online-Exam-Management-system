<div class="portlet light bordered">
    <div class="portlet-body ">
        <div class="row">
            ...
            <div class="col-md-12">
                <label class="text-left bold" style="width: 50%">{{trans('english.TIME')}}: {{(strlen($epeInfo->obj_duration_hours) === 1) ? '0'.$epeInfo->obj_duration_hours : $epeInfo->obj_duration_hours }}:{{(strlen($epeInfo->obj_duration_minutes) === 1) ? '0'.$epeInfo->obj_duration_minutes : $epeInfo->obj_duration_minutes }}</label><label class="text-right" style="width: 50%"><strong>{{trans('english.FULL_MARKS')}}:</strong> {{ Custom::numberFormat($markDistribution->objective) }}</label>
            </div>
        </div>
