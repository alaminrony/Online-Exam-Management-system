<div class="portlet light bordered">
    <div class="portlet-body ">
        <div class="row">
            ...
            <div class="col-md-12">
                <label class="text-left bold" style="width: 50%">{{__('label.TIME')}}: {{(strlen($epeInfo->sub_duration_hours) === 1) ? '0'.$epeInfo->sub_duration_hours : $epeInfo->sub_duration_hours }}:{{(strlen($epeInfo->sub_duration_minutes) === 1) ? '0'.$epeInfo->sub_duration_minutes : $epeInfo->sub_duration_minutes }}</label><label class="text-right" style="width: 50%"><strong>{{__('label.FULL_MARKS')}}:</strong></label>
            </div>
            <div class="col-md-12">
                <p class="bold text-left" style="text-decoration: underline;">{{__('label.THE_FIGURES_IN_THE_MARGIN_INDICATE_ALLOTTED_MARKS')}} (any {{$epeInfo->sub_no_mandatory}})</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
