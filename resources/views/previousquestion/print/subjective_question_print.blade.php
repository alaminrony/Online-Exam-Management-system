<html>
    ...
    <body>
        <div class="row">
            ...
            <div class="col-md-12">
                <p class="font-bold text-left" style="text-decoration: underline;">{{trans('english.THE_FIGURES_IN_THE_MARGIN_INDICATE_ALLOTTED_MARKS')}} (any {{$epeInfo->sub_no_mandatory}})</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
