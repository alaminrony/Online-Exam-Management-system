...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-graduation-cap"></i>@lang('label.CREATE_MOCK_TEST') </div>
            <div class="tools">
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label class="col-md-4 control-label">@lang('label.SELECT_EPE') :<span class="required"> *</span></label>
                            <div class="col-md-8">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-3 col-md-9">
                        <button type="submit" class="btn btn-circle green" id="mockTestSubmit"><i class="fa fa-save"></i> @lang('label.SAVE')</button>
