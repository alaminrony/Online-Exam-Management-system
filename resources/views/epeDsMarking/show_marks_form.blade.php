<div class="modal-header portlet-title" style="background-color: #32c5d2; color: #fff;">
    ...
    <h4 class="modal-title"><strong>{{__('label.ASSIGN_MARKS_TO')}} {{$submittedTaeObjArr->student_name}} ({{$submittedTaeObjArr->registration_no}})</strong></h4>
</div>
{{ Form::open(array('role' => 'form', 'url' => '#', 'class' => 'form-horizontal form-row-seperated', 'id' => 'formAssigMarks')) }}
<div class="modal-body">
    <div class="col-md-12">
        <div class="form-group">
            <label class="col-md-4 control-label">{{__('label.EPE_TOTAL_MARKS')}} :</label>
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <span class="input-group-addon"> {{__('label.PASSING')}} </span>
        ...
        @if(Auth::user()->group_id == '3')
         <div class="form-group">
             <label class="col-md-4 control-label" for="assignMarksCiRemarks">{{__('label.CI_REMARKS')}}:<span class="required">*</span></label>
            <div class="col-md-6">
        ...
        <div class="form-group static-info">
            <label class="col-md-4 control-labele"><strong></strong>{{__('label.TOTAL_ARCHIEVED_MARKS')}}:</label>
            <div class="col-sm-6">
...
<!--        <div class="form-group static-info">
            <div class="col-sm-6 text-right">
                <label class="control-label name"><strong></strong>{{__('label.TOTAL_ARCHIEVED_MARKS')}}:</label>
            </div>
...
<div class="modal-footer text-center" style="background-color: #f5f5f5;border-top: 1px solid #e7ecf1;">
    ...
    <button class="btn btn-circle btn-info" type="button"  onclick="assign_mark_fields();"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> {{__('label.ADD_QUESTION')}}</button>
    @endif
    <button type="button" class="btn btn-circle green" id="saveAssignMarks"><i class="fa fa-check"></i> {{__('label.SUBMIT')}}</button>
    <button type="button" class="btn grey-salsa btn-circle" data-dismiss="modal">{{__('label.CANCEL')}}</button>
