                ...
                <div class="portlet-body ">
                    ...
                    <div class="mt-element-step">
                        ...
                        <div class="row step-no-background-thin">
                            ...
                            <div class="mt-step-desc">
                                <div class="font-grey-cascade"><strong>Mark : </strong><span class="<?php echo $class; ?>">{{$mark}}</span></div>
                            </div>
                            ...
                            <div class="mt-step-desc">
                                <div class="font-grey-cascade"><strong>Mark : </strong><span class="<?php echo $trueFalseclass; ?>">{{$mark}}</span></div>
                            </div>
                            @endif
