        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-graduation-cap"></i>{{trans('english.UPDATE_A_STUDENT')}} 
                    </div>
                </div>
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {{ Form::model($student, array('route' => array('student.update', $student->id), 'method' => 'PATCH', 'files'=> true, 'class' => 'form-horizontal', 'id' => 'studentId')) }}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {{Form::select('rank_id', $rankList, Request::get('rank_id'), array('class' => 'form-control js-source-states', 'id' => 'userRankId'))}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {{Form::select('appointment_id', $appointmentList, Request::get('appointment_id'), array('class' => 'form-control js-source-states', 'id' => 'userApprointmentId'))}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {{ Form::text('official_name', Request::get('official_name'), array('id'=> 'userOfficialName', 'class' => 'form-control', 'placeholder' => 'Enter Official Name', 'required' => 'true')) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-icon">
                                            ...
                                            {{ Form::text('phone_no',Request::get('service_no'), array('id'=> 'userPhoneNumber', 'class' => 'form-control', 'placeholder' => 'Enter Phone Number')) }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group date date-picker" data-date="{{ date("Y-m-d")}}" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                            {{ Form::text('commission_date',Request::get('commission_date'), array('class' => 'form-control', 'id' => 'commissionDdate', 'readonly' => true)) }}
                                            <span class="input-group-addon">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {{ Form::text('service_no', Request::get('service_no'), array('id'=> 'userServiceNO', 'class' => 'form-control', 'placeholder' => 'Enter Service NO', 'required' => 'true')) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {{Form::select('status', $status, Request::get('status'), array('class' => 'form-control js-source-states-hidden-search', 'id' => 'userStatus'))}}
                                    ...
                                    <div class="col-md-9">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                ...
                                                <img src="{{URL::to('/')}}/public/uploads/user/{{$student->photo}}" alt="{{ $student->official_name }}"> 
                                                @else
                                                <img src="{{URL::to('/')}}/public/img/no-image.png" alt="{{ $student->official_name }}"> 
                                                @endif
                                            </div>
...
<script type="text/javascript">
    ...
    $(document).on("submit", '#studentId', function (e) {
