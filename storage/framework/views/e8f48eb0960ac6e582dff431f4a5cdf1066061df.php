...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-file-image-o"></i><?php echo app('translator')->get('label.CREATE_GALLERY'); ?> </div>
            <div class="tools">
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo e(Form::open(array('role' => 'form', 'url' => 'gallery', 'files'=> true, 'class' => 'form-horizontal', 'id'=>'galleryCreate'))); ?>

            <div class="form-body">
                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label class="col-md-4 control-label"><?php echo app('translator')->get('label.THUMB'); ?> :</label>
                            <div class="col-md-8">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <span class="help-block"><?php echo app('translator')->get('label.ONLY_SUPPORTED'); ?></span>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label"><?php echo app('translator')->get('label.PHOTO'); ?> :</label>
                            <div class="col-md-8">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <span class="btn default btn-file">
                                        <span class="fileinput-new"><?php echo app('translator')->get('label.SELECT_PHOTO'); ?>  </span>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label"><?php echo app('translator')->get('label.SHOW_HOME'); ?> :</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <?php echo e(Form::select('order',$orderList,Request::get('order'), array('id'=> 'home_order', 'class' => 'form-control js-source-states'))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/gallery/create.blade.php ENDPATH**/ ?>