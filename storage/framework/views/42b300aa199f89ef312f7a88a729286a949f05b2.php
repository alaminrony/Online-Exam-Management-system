...
<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="logoTile">
                <span><?php echo app('translator')->get('label.BRANCH_RESULT'); ?></span>
            </div>
        ...
        <div class="row">
            <div class="text-center">
                <label><b><?php echo app('translator')->get('label.BRANCH'); ?>:</b> <?php echo e(!empty($branchList[$request->branch_id])? $branchList[$request->branch_id] : 'N/A'); ?></label>
        ...
        <table>
            <tr>
                <td>
                    <label><?php echo app('translator')->get('label.BRANCH'); ?>: <?php echo e($branchList[$request->branch_id] > '0' ? $branchList[$request->branch_id] : 'N/A'); ?></label>
...
<?php /**PATH C:\xampp\htdocs\oem\resources\views/report/branchResult/print/branchResultReport.blade.php ENDPATH**/ ?>