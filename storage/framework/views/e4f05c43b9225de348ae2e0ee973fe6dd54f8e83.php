...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i><?php echo app('translator')->get('label.CHANGE_PASSWORD'); ?> 
            </div>
            <div class="tools">
            </div>
        </div>
        <div class="portlet-body form">
                        ...
                        <tr>
                            <td>
                                <address class="text-left">
                                    ...
                                    <strong><?php echo app('translator')->get('label.RANK'); ?>: </strong><?php echo e($userInfo->rank_title); ?><br />
            ...
            <!-- BEGIN FORM-->
            <?php echo e(Form::open(array('group' => 'form', 'url' => 'changePassword', 'class' => 'form-horizontal', 'id'=>'pup'))); ?>

            <?php echo e(Form::hidden('filter', Helper::queryPageStr($qpArr))); ?>

            <?php echo e(Form::hidden('id', $id)); ?>

            <?php echo e(Form::hidden('next_url', $nextUrl)); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/user/changePassword.blade.php ENDPATH**/ ?>