...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-book"></i><?php echo e(__('label.EPE_MARKING_SUBJECTIVE')); ?>
        ...
        <div class="portlet-body form">
            <div class="form-body">
                <?php echo e(Form::open(array('role' => 'form', 'url' => 'submitSubjectiveMarking', 'class' => 'form-horizontal', 'id' => 'submitData'))); ?>

                <div class="row">
                    <div class="col-md-offset-2 col-md-7">
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="epeId"><?php echo e(__('label.SELECT_EPE')); ?>:<span class="required">*</span></label>
                            <div class="col-md-8">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#courseId").change(function () {
            $.ajax({
                url: "<?php echo e(URL::to('epedsmarking/show_part_list')); ?>",
                type: "GET",
                dataType: "json",
        ...
        $("#partId").change(function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('epedsmarking/show_subject')); ?>",
                type: "POST",
    ...
    function epeAssignMarks(epeId) {
        $.ajax({
            url: "<?php echo e(URL::to('epedsmarking/show_submitted_epe')); ?>",
            type: "POST",
            headers: {
            ...
            cancelButtonText: 'No, I do not agree',
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            url: "<?php echo e(URL::to('submitSubjectiveMarking')); ?>",
                            type: "POST",
                            data: resultData,
                            dataType: 'json',
                            cache: false,
...
//        return false;
        ...
        if (confirm('Student marks not yet put. Are you sure, you want to lock?')) {
            $.ajax({
                url: "<?php echo e(URL::to('epedsmarking/marks_lock')); ?>",
                type: "POST",
                data: {
                    tae_id: taeId
                },
    ...
    $(document).on('click', '#marks-unlock', function (e) {
        ...
        if (confirm('Are you sure you want to unlock this marks?')) {
            $.ajax({
                url: "<?php echo e(URL::to('epedsmarking/marks_unlock')); ?>",
                type: "POST",
                data: {
                    tae_id: taeId
                },
    ...
    $(function () {
        $(document).on("click", "#showAssignment", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('epedsmarking/show_file')); ?>",
                type: "POST",
                ...
                success: function (response) {
                    ...
                    var src = "<?php echo e(URL::to('/')); ?>/public/uploads/assignment/" + fileName;
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/epeDsMarking/index.blade.php ENDPATH**/ ?>