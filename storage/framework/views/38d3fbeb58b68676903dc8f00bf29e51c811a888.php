...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-book"></i><?php echo e(__('label.EPE_ATTENDEE')); ?>
        ...
        <div class="portlet-body form">
            <div class="form-body">
                <?php echo e(Form::open(array('role' => 'form', 'url' => '#', 'class' => 'form-horizontal', 'id' => 'lockData'))); ?>

                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label class="col-md-5 control-label" for="subjectId"><?php echo e(__('label.SUBJECT')); ?>:<span class="required">*</span></label>
                            <div class="col-md-7">
                                <?php echo e(Form::select('subject_id', $subjectList, Request::get('subject_id'), array('class' => 'form-control js-source-states', 'id' => 'subjectId'))); ?>
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            <label class="col-md-5 control-label" for="epeId"><?php echo e(__('label.EPE')); ?>:<span class="required">*</span></label>
                            <div class="col-md-7">
                        ...
                        <!--                                <div class="col-md-offset-4 col-md-2" id="refreshShow" style="display:none">
                                                            <div class="text-right ">
                                                                <button class="btn btn-circle green-jungle tooltips" id="refreshId">
                                                                    <i class="fa fa-refresh" title="<?php echo e(__('label.REFRESH')); ?>"></i>
                                                                </button>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#subjectId").change(function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('epeattendee/show_epe')); ?>",
                type: "POST",
                headers: {
    ...
    function epeAssignMarks(subjectId, epeId) {
        $.ajax({
            url: "<?php echo e(URL::to('epeattendee/show_attendee_epe')); ?>",
            type: "POST",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
...
//    });
    ...
    $(document).on('click', '#forceSubmit', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(URL::to('epeattendee/forceSubmit')); ?>",
            type: "POST",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
    ...
    $(document).on('click', '#saveForceSubmit', function (e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(URL::to('epeattendee/saveForceSubmit')); ?>",
            type: "POST",
            data: formData,
            dataType: 'json',
            cache: false,
            ...
            async: true,
            success: function (response) {
                toastr.success('<?php echo e(trans("label.FORCE_SUBMITTED_SUCCESSFULLY")); ?>', "Success", {"closeButton": true});
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/epeAttendee/index.blade.php ENDPATH**/ ?>