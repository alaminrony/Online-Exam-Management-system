                        ...
                        <div class="col-md-3">
                            <div class="text-center">
                                <div class="dot bg-white rounded dot-border-1 margin-bottom-10">
                                    <span class="bold text-center" data-counter="counterup" data-value="<?php echo !empty($subjectList) ? count($subjectList) : 0; ?>"><?php echo !empty($subjectList) ? count($subjectList) : 0; ?></span>
                                </div><br>
                                <span class="bold"><?php echo app('translator')->get('label.SUBJECTS'); ?></span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div style="text-align:center">
                                <div class="dot bg-white rounded dot-border-2 margin-bottom-10">
                                    <span class="bold text-center" data-counter="counterup" data-value="<?php echo !empty($questionList) ? count($questionList) : 0; ?>"><?php echo !empty($questionList) ? count($questionList) : 0; ?></span>
                                </div><br>
                                <span class="bold"><?php echo app('translator')->get('label.QUESTIONS'); ?></span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div style="text-align:center">
                                <div class="dot bg-white rounded dot-border-3 margin-bottom-10">
                                    <span class="bold text-center" data-counter="counterup" data-value="<?php echo !empty($branchList) ? count($branchList) : 0; ?>"><?php echo !empty($branchList) ? count($branchList) : 0; ?></span>
                                </div><br>
                                <span class="bold"><?php echo app('translator')->get('label.BRANCHES'); ?></span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div style="text-align:center">
                                <div class="dot bg-white rounded dot-border-4 margin-bottom-10">
                                    <span class="bold text-center" data-counter="counterup" data-value="<?php echo !empty($clusterList) ? count($clusterList) : 0; ?>"><?php echo !empty($clusterList) ? count($clusterList) : 0; ?></span>
                                </div><br>
                                <span class="bold"><?php echo app('translator')->get('label.CLUSTERS'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12">
            <div class="row margin-top-15">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 blue-dark todays-exam-details tooltips" href="#modalTodaysExamDetails" id="todaysExamDetails" data-toggle="modal" title="<?php echo app('translator')->get('label.CLICK_TO_VIEW_TODAYS_EXAM_DETAILS'); ?>">
                        ...
                        <div class="details col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="desc"> <?php echo app('translator')->get('label.TODAYS_EXAMS'); ?></div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 blue-soft" href="<?php echo URL::to('/epe'); ?>">
                        <div class="visual col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <i class="fa fa-file-text-o"></i>
                        </div>
                        <div class="details col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="desc"> <?php echo app('translator')->get('label.EPE_EXAM'); ?> </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 green-sharp" href="<?php echo URL::to('/question'); ?>">
                        <div class="visual col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <i class="icon-note"></i>
                        </div>
                        <div class="details col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="desc"> <?php echo app('translator')->get('label.QUESTION_BANK'); ?> </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 purple" href="<?php echo URL::to('/examtostudent'); ?>">
                        <div class="visual col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <i class="icon-equalizer"></i>
                        </div>
                        <div class="details col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="desc"> <?php echo app('translator')->get('label.ASSIGN_EXAM_TO_EMPLOYEE'); ?> </div>
                        </div>
                    </a>
                </div>
            </div>
...
<script>
            $(function () {
                $(document).on("click", ".todays-exam-details", function (e) {
                    e.preventDefault();
                    $.ajax({
                        url: "<?php echo e(URL::to('dashboard/getTodaysExamDetails')); ?>",
                        type: "POST",
                        dataType: "json",
                        headers: {
...
?>
                    ...
                    title: {
                        text: "<?php echo app('translator')->get('label.EXAMINEE_STATISTICS_LAST_6_MONTHS'); ?>",
                        align: 'center'
                    },
                    grid: {
                        row: {
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/admin/adminDashboard.blade.php ENDPATH**/ ?>