...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                    <i class="fa fa-bookmark"></i><?php echo app('translator')->get('label.BRANCH_LOG_REPORT'); ?>
            </div>
            <?php if(!empty($request->generate) && $request->generate == 'true'): ?>
            <div class="pull-right" style="margin-top: 3px;" id="groupIcon">
                <a href="<?php echo e(URL::to('branchLogReport?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&view=print')); ?>"  title="view Print" target="_blank" class="btn btn-info tooltips rounded-0 print"><i class="fa fa-print"></i></a>
                <a href="<?php echo e(URL::to('branchLogReport?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&view=pdf')); ?>"  title="Download PDF File" class="btn btn-warning tooltips rounded-0 pdf"><i class="fa fa-file-pdf-o"></i></a>
                <a href="<?php echo e(URL::to('branchLogReport?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&view=excel')); ?>"  title="Download Excel" target="_blank" class="btn btn-danger tooltips rounded-0"><i class="fa fa-file-excel-o"></i></a>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'branchLogReport/generate','class' => 'form-horizontal')); ?>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr class="center">
                            ...
                            <th><?php echo app('translator')->get('label.AFFECTED_BRANCH'); ?></th>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($branchList[$target['affected_branch_id']]??''); ?></td>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/logReport/branchLogReport/branchLog.blade.php ENDPATH**/ ?>