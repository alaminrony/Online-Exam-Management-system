...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark"></i><?php echo app('translator')->get('label.CLUSTER_RESULT'); ?>
            </div>
            ...
            <div class="pull-right" style="margin-top: 3px;" id="groupIcon">
                <a href="<?php echo e(URL::to('clusterResult?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&cluster_id='.Request::get('cluster_id').'&view=print')); ?>"  title="view Print" target="_blank" class="btn btn-info tooltips rounded-0 print"><i class="fa fa-print"></i></a>
                <a href="<?php echo e(URL::to('clusterResult?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&cluster_id='.Request::get('cluster_id').'&view=pdf')); ?>"  title="Download PDF File" class="btn btn-warning tooltips rounded-0 pdf"><i class="fa fa-file-pdf-o"></i></a>
                <a href="<?php echo e(URL::to('clusterResult?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&cluster_id='.Request::get('cluster_id').'&view=excel')); ?>"  title="Download Excel" target="_blank" class="btn btn-danger tooltips rounded-0"><i class="fa fa-file-excel-o"></i></a>
            </div>
            <?php endif; ?>
            <?php endif; ?>
        </div>
        ...
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'clusterResult/generate','class' => 'form-horizontal')); ?>

            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="clusterId"><?php echo app('translator')->get('label.CLUSTER'); ?>:<span class="text-danger">*</span></label>
                        <div class="col-md-8">
                            <?php echo Form::select('cluster_id',$clusterList,Request::get('cluster_id'),['class' => 'form-control js-source-states','id'=>'clusterId']); ?>

                            <span class="text-danger"><?php echo e($errors->first('cluster_id')); ?></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-blue-hoki bg-font-blue-hoki">
                <h5 style="padding: 10px;">
                    <?php echo app('translator')->get('label.CLUSTER'); ?> : <strong><?php echo e(!empty($clusterList[$request->cluster_id]) ? $clusterList[$request->cluster_id] : 'N/A'); ?> |</strong>
...
<?php } ?>
            ...
            yaxis: {
            title: {
            text: "<?php echo app('translator')->get('label.AVERAGE_MARKS'); ?>"
            },
                    min: 5,
                    max: 100
            },
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/report/clusterResult/clusterResultReport.blade.php ENDPATH**/ ?>