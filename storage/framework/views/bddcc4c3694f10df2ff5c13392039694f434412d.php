...
<html>
    ...
    <body>
         <div class="header">
            ...
            <div class="logoTile">
                <span><?php echo app('translator')->get('label.CLUSTER_RESULT'); ?></span>
            </div>
        ...
        <div class="row">
            <div class="text-center">
                <label><b><?php echo app('translator')->get('label.CLUSTER'); ?>:</b> <?php echo e($clusterList[$request->cluster_id] > '0' ? $clusterList[$request->cluster_id] : 'N/A'); ?></label>
        ...
        <table>
            <tr>
                <td>
                    <label><?php echo app('translator')->get('label.CLUSTER'); ?>: <?php echo e($clusterList[$request->cluster_id] > '0' ? $clusterList[$request->cluster_id] : 'N/A'); ?></label>
...
<?php /**PATH C:\xampp\htdocs\oem\resources\views/report/clusterResult/printClusterResultReport.blade.php ENDPATH**/ ?>