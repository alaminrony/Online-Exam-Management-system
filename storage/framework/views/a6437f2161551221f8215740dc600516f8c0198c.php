...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cubes"></i><?php echo app('translator')->get('label.UPDATE_BRANCH'); ?> </div>
            <div class="tools">
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo e(Form::model($target, array('route' => array('branch.update', $target->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'branchUpdate'))); ?>
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::select('cluster_id', $clusterList, Request::get('cluster_id'), array('class' => 'form-control js-source-states', 'id' => 'clusterId'))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/branch/edit.blade.php ENDPATH**/ ?>