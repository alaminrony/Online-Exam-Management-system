...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i><?php echo app('translator')->get('label.CREATE_NEW_USER'); ?> </div>
            <div class="tools"></div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo e(Form::open(array('role' => 'form', 'url' => 'user', 'files'=> true, 'class' => 'form-horizontal', 'id'=>'submitForm'))); ?>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="groupId"><?php echo app('translator')->get('label.GROUP'); ?> :<span class="required"> *</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="approintmentId"><?php echo app('translator')->get('label.SELECT_APPROINTMENT'); ?> :<span class="required"> *</span></label>
                            <div class="col-md-8">
                                <?php echo e(Form::select('designation_id', $appointmentList, Request::get('designation_id'), array('class' => 'form-control js-source-states', 'id' => 'approintmentId'))); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <span class="help-block">
                                    ...
                                    ?> minimum <?php echo e($passwordSetup->minimum_length); ?> & maximum <?php echo e($passwordSetup->maximum_length); ?> character.
                                </span>
                                <span class="help-block text-danger"> <?php echo e($errors->first('password')); ?></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="confirmPassword"><?php echo app('translator')->get('label.CONFIRM_PASSWORD'); ?> :</label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    <?php echo e(Form::password('password_confirmation', array('id'=> 'confirmPassword', 'class' => 'form-control'))); ?>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="email"><?php echo app('translator')->get('label.EMAIL'); ?> :<span class="required"> *</span></label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-envelope"></i>
                                    </span>
                                    <?php echo e(Form::email('email', Request::get('email'), array('id'=> 'email', 'class' => 'form-control'))); ?>
    ...
    $(function () {
        ...
        $(document).on('click', '.forward-btn', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(URL::to('dpmAppManage/forwardAndApprove')); ?>",
                        type: "POST",
                        datatype: 'json',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/user/create.blade.php ENDPATH**/ ?>