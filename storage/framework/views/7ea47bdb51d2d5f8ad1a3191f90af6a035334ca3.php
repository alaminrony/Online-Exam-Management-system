...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-pencil-square-o"></i><?php echo app('translator')->get('label.VIEW_EXAM'); ?>
            </div>
            <div class="actions">
                <a href="<?php echo e(URL::to('epe/create')); ?>" class="btn btn-default btn-sm">
                    <i class="fa fa-plus"></i> <?php echo app('translator')->get('label.CREATE_EXAM'); ?> </a>
            </div>
        </div>
        <div class="portlet-body">
            <?php echo e(Form::open(array('role' => 'form', 'url' => 'epe/filter', 'class' => '', 'id' => 'epeFilter'))); ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('search_text', Request::get('search_text'), array('id'=> 'epeSearchText', 'class' => 'form-control', 'placeholder' => 'Search by Title/Exam Date'))); ?>
                        ...
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr class="contain-center">
                                    ...
                                    <th class="text-center"><?php echo app('translator')->get('label.SUBJECT_INFO'); ?></th>
                                    <th class="text-center"><?php echo app('translator')->get('label.EXAM_TYPE'); ?></th>
                                    <th><?php echo app('translator')->get('label.TITLE'); ?></th>
                                    <th><?php echo app('translator')->get('label.EXAM_INFO'); ?></th>
                                    <th class="text-center"><?php echo app('translator')->get('label.NO_OF_MOCK_TEST'); ?></th>
                                    <th class="text-center"><?php echo app('translator')->get('label.QUESTION_SELECTION'); ?></th>
                            ...
                            <tbody>
                                ...
                                $epeDurationInfo = '';
                                ?>
                                <tr class="<?php echo e($expiryEpe); ?> contain-center">
                                    <td><?php echo e(++$sl); ?></td>
                                    <td>
                                        <label><?php echo app('translator')->get('label.SUBJECT'); ?> : <?php echo $value->subject->title .' &raquo; '.$value->subject->code; ?></label><br/>
                                    </td>
                                    <td>
                                        <?php if($value->type == '1'): ?>
                                        <span class="label label-success"><?php echo __('label.REGULAR'); ?></span>
                                        <?php else: ?>
                                        <span class="label label-warning"><?php echo __('label.RETAKE'); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e($value->title); ?></td>
                                    <td>
                                        <label><?php echo app('translator')->get('label.EXAM_DATE'); ?> : <?php echo e($value->exam_date); ?></label><br/>
                                        <label><?php echo app('translator')->get('label.START_TIME'); ?> : <?php echo e(substr($value->start_time, 0,-3)); ?></label><br/>
                                        <label><?php echo app('translator')->get('label.END_TIME'); ?> : <?php echo e(substr($value->end_time, 0, -3)); ?></label><br/>
                                        <label class="tooltips"><?php echo app('translator')->get('label.DURATION'); ?> : <?php echo e($totalDurationTime); ?></label><br/>
                                    </td>
                                    <td class="text-center"><?php echo e($value->no_of_mock); ?></td>
                                    ...
                                    <td class="action-center">
                                        <div class="text-center user-action">
                                            <?php echo e(Form::open(array('url' => 'epe/' . $value->id, 'id' => 'delete'))); ?>

                                            <?php echo e(Form::hidden('_method', 'DELETE')); ?>

                                            
                                             
                                            <?php if(empty($value->epe_submitted)): ?>
                                            <a class='btn btn-primary btn-sm tooltips' href="<?php echo e(URL::to('epe/' . $value->id . '/edit')); ?>" title="Edit for <?php echo e($value->subject->title); ?>">
                                                <i class='fa fa-edit'></i>
                                            </a>
                                            <a class='btn btn-primary btn-sm green tooltips' href="<?php echo e(URL::to('epe/questionset/' . $value->id)); ?>"  title="<?php echo app('translator')->get('label.OBJECTIVE_QUESTION_SETS'); ?>">
                                                <i class='fa fa-question-circle'></i>
                                            </a>
                                            <?php endif; ?>
                                            
                                            <a class='btn btn-warning btn-sm tooltips' href="<?php echo e(URL::to('epe/create?exam_id='. $value->id)); ?>" title="Clone for <?php echo e($value->subject->title); ?>">
                                                <i class='fa fa-clone'></i>
                                            </a>

                                            <a class="tooltips get-objective-Question" data-toggle="modal" data-target="#view_objective_question" data-id="<?php echo e($value->id); ?>" href="#view_objective_question" id="getObjectiveQuestion<?php echo e($value->id); ?>" title="<?php echo app('translator')->get('label.VIEW_OBJECTIVE_QUESTION'); ?>" data-container="body" data-trigger="hover" data-placement="top">
                                                <span class="btn btn-success btn-sm yellow "> 
                                                    &nbsp;<i class='fa fa-question'></i>&nbsp;
                                                </span>
                                            </a>
                                            <!--objective question print-->
                                            <a class="tooltips" href="<?php echo e(url('epe/question_details?view=print&epe_id='.$value->id)); ?>" title="<?php echo app('translator')->get('label.PRINT_OBJECTIVE_QUESTION'); ?>" target="_blank">
                                                <span class="btn btn-sm yellow-mint"> 
                                                    &nbsp;<i class='fa fa-print'></i>&nbsp;
                                                </span>
                                            </a>  

                                            <a class="tooltips" data-toggle="modal" data-target="#view-modal" data-id="<?php echo e($value->id); ?>" href="#view-modal" id="getepeInfo" title="<?php echo app('translator')->get('label.DETAILS_EPE'); ?>" data-container="body" data-trigger="hover" data-placement="top">
                                                <span class="btn btn-warning btn-sm"> 
                                                    &nbsp;<i class='fa fa-info'></i>&nbsp;
                                                </span>
                                            </a>
                                            <?php if(Auth::user()->group_id <= 3): ?>
                                            <a class='btn btn-primary btn-sm green tooltips' data-toggle="modal" data-target="#view_publish_date" data-id="<?php echo e($value->id); ?>" href="#view_publish_date" id="updatePublish" title="Modify Deadline">
                                                <i class='fa fa-pencil'></i>
                                            </a>
                                            <?php endif; ?>

                                            <?php if(empty($value->epe_submitted)): ?>
                                            <button class="btn btn-danger btn-sm tooltips delete" type="submit" data-placement="top" data-rel="tooltip" data-original-title="Delete EPE <?php echo e($value->subject->title .' &raquo; '.$value->subject->code); ?>" title="Delete EPE <?php echo e($value->subject->title .' &raquo; '.$value->subject->code); ?>">
                                ...
                                <?php else: ?>
                                <tr>
                                    <td colspan="13"><?php echo app('translator')->get('label.EMPTY_DATA'); ?></td>
                                </tr>
                                <?php endif; ?> 
                            </tbody>
                        </table>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header clone-modal-header">
                ...
                <h4 class="modal-title"><?php echo app('translator')->get('label.VIEW_SUBJECTIVE_QUESTION'); ?></h4>
            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on('click', '.get-objective-Question', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('epe/questionDetails')); ?>",
                type: "GET",
                data: {
                    epe_id: epeId
                },
        ...
        $(document).on('click', '.get_subjective_question', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('epe/subjective_question_details/')); ?>",
                type: "GET",
                data: {
                    epe_id: epeId
                },
        ...
        $(document).on('click', '#getepeInfo', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('ajaxresponse/epeInfo')); ?>",
                type: "GET",
                data: {
                    epe_id: epeId
                },
        ...
        $(document).on('click', '#updatePublish', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('epe/update_publish')); ?>",
                type: "GET",
                data: {
                    id: epeId
                },
        ...
        $(document).on('submit', '#updatedPublishResult', function (event) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('epe/updated_publish')); ?>",
                type: "POST",
                data: updatedPublish,
                dataType: "json",
                success: function (response) {
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/epe/index.blade.php ENDPATH**/ ?>