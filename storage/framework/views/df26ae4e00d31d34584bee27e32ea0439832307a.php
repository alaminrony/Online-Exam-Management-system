...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i><?php echo e(__('label.ASSIGN_EXAM_TO_STUDENT')); ?> </div>
            <div class="tools">
                ...
                <div class="row">
                    <div class="col-md-12 margin-bottom-10">
                        <div class="form-group">
                            <label class="col-md-3 text-right control-label"><?php echo e(__('label.SELECT_EXAM')); ?> :<span class="required"> *</span></label>
                            <div class="col-md-6">
                                <?php echo e(Form::select('exam_id', $examList, Request::get('exam_id'), array('class' => 'form-control js-source-states', 'id' => 'examId'))); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#examId").change(function () {
            ...
            if (examId != '') {
                $.ajax({
                    url: "<?php echo e(URL::to('examtostudent/getStudent')); ?>",
                    type: "POST",
                    dataType: "json",
                    headers: {
    ...
    $(document).ready(function () {
        $(document).on('click', '#showAssignedStudent', function () {
            ...
            if(examId !=''){
                $.ajax({
                    url:"<?php echo e(route('epe.getAssignedStudent')); ?>",
                    type:"post",
                    data:{exam_id:examId},
                    dataType:"json",
                    headers:{
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/examtostudent/index.blade.php ENDPATH**/ ?>