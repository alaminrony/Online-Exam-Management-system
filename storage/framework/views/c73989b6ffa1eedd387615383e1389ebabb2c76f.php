...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <a class="dashboard-stat dashboard-stat-v2 dashboard-card <?php echo $colorArr[$i]; ?> popovers" <?php echo $activeEpe; ?>>
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="note note-warning">
                    <h3><?php echo e(__('label.THERE_IS_NO_MOCK_TEST_AVAILABLE_AT_THIS_MOMENT')); ?></h3>
                </div>
            </div>
...
<link href="<?php echo e(asset('public/assets/global/plugins/bootstrap-modal/js/bootstrap-modalmanager.js')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset('public/assets/global/plugins/bootstrap-modal/js/bootstrap-modal.js')); ?>" rel="stylesheet" type="text/css" />
<script type="text/javascript">
    ...
    function showExamBox(mockId) {
        $.ajax({
            url: "<?php echo e(URL::to('isspstudentactivity/mockexam')); ?>",
            type: "GET",
            headers: {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#mymocklist', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('isspstudentactivity/mymocklist')); ?>",
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
        ...
        $(document).on('click', '.mockplay', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('isspstudentactivity/mockplay')); ?>",
                type: "GET",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/isspstudentactivity/mockTest.blade.php ENDPATH**/ ?>