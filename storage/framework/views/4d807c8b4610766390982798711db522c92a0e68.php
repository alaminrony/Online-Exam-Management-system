...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark"></i><?php echo app('translator')->get('label.STAFF_TREND_ANALYSIS'); ?>
            </div>
            ...
            <div class="pull-right" style="margin-top: 3px;" id="groupIcon">
                <a href="<?php echo e(URL::to('staffTrendAnalysis?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&employee_id='.Request::get('employee_id').'&view=print')); ?>"  title="view Print" target="_blank" class="btn btn-info tooltips rounded-0 print"><i class="fa fa-print"></i></a>
                <a href="<?php echo e(URL::to('staffTrendAnalysis?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&employee_id='.Request::get('employee_id').'&view=pdf')); ?>"  title="Download PDF File" class="btn btn-warning tooltips rounded-0 pdf"><i class="fa fa-file-pdf-o"></i></a>
                <a href="<?php echo e(URL::to('staffTrendAnalysis?generate=true&from_date='.Request::get('from_date').'&to_date='.Request::get('to_date').'&employee_id='.Request::get('employee_id').'&view=excel')); ?>"  title="Download Excel" target="_blank" class="btn btn-danger tooltips rounded-0"><i class="fa fa-file-excel-o"></i></a>
            </div>
            <?php endif; ?>
            <?php endif; ?>
        </div>
        ...
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'staffTrendAnalysis/gererate','class' => 'form-horizontal')); ?>
            ...
            <?php if(!empty($request->generate) && $request->generate == 'true'): ?>
             <div class="bg-blue-hoki bg-font-blue-hoki">
                <h5 style="padding: 10px;">
                    <?php echo app('translator')->get('label.EMPLOYEE'); ?> : <strong><?php echo e(!empty($employeeArr[$request->employee_id]) ? $employeeArr[$request->employee_id] : 'N/A'); ?> |</strong>
...
$(this).attr('data-id', '1');
        ...
        series: [
        {
        name: "<?php echo app('translator')->get('label.ACHIEVED_MARKS'); ?>",
                data: [
<?php
if (!empty($finalArr)) {
    foreach ($finalArr as $result) {
        ?>
                        "<?php echo e(Helper::numberformat($result['achieved_mark_per'])); ?>",
        <?php
    }
}
?>
...
?>
                        ...
                        title: {
                        text: "<?php echo app('translator')->get('label.EXAM'); ?>",
                        }
                },
                yaxis: {
                labels: {
                ...
                return value + "%";
                        ...
                        title: {
                        text: "<?php echo app('translator')->get('label.ACHIEVED_MARKS'); ?> (%)",
                        },
                        min:5,
                        max: 100,
                },
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/report/staffTrendAnalysis/staffTrendAnalysisReport.blade.php ENDPATH**/ ?>