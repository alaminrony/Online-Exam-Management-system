...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="icon-tag"></i><?php echo app('translator')->get('label.UPDATE_QUESTION'); ?>
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">         
            <?php echo e(Form::model($target, array('route' => array('question.update', $target->id), 'files' => true, 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'questionUpdate'))); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?php echo e(Form::select('subject_id', $subjectArr,!empty($target->subject_id) ? $target->subject_id : Request::get('subject_id'), array('class' => 'form-control js-source-states', 'id' => 'subject_id'))); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?php echo e(Form::select('type_id', $typeArr, !empty($target->type_id) ? $target->type_id : Request::get('type_id'), array('class' => 'form-control js-source-states', 'id' => 'type_id'))); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-3 mul-ques-radio-btn">
                                        <label class="mt-radio">
                                            <?php echo e(Form::radio('mcq_answer',$i,$target->mcq_answer == $i ? true :false)); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?php echo e(Form::select('content_type_id',$contentTypeList, !empty($target->content_type_id) ? $target->content_type_id : '0', array('class' => 'form-control','id'=>'contentTypeId'))); ?>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo e(__('label.STATUS')); ?> : </label>
                            <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        <?php if(empty(old('type_id'))): ?>
                <?php if($target->type_id != '1'): ?>
                $("#multipleChoice").hide();
                <?php endif; ?>
                <?php if($target->type_id != '3'): ?>
                $("#ftbAnswer").hide();
                <?php endif; ?>
                <?php if($target->type_id == '4'): ?>
                $("#appearanceId").hide();
                <?php endif; ?>
                <?php if($target->type_id != '5'): ?>
                $("#trueFalseAnswer").hide();
                <?php endif; ?>
                <?php if($target->type_id != '6'): ?>
                $("#matchingAnswer").hide();
                <?php endif; ?>
                <?php if(Request::get('type_id') == '0'): ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/question/edit.blade.php ENDPATH**/ ?>