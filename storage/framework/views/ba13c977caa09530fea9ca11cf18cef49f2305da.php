...
<script src="<?php echo e(asset('public/assets/pages/scripts/components-select2.min.js')); ?>" type="text/javascript"></script>
...
<!-- SWEETALERT SCRIPTS -->
<script src="<?php echo e(asset('public/assets/global/plugins/sweetalert/lib/sweet-alert.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('public/assets/global/plugins/clockface/js/clockface.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/pages/scripts/components-date-time-pickers.min.js')); ?>" type="text/javascript"></script>
<!-- toaster SCRIPTS -->
...
<script src="<?php echo e(asset('public/js/product-form.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('public/assets/pages/scripts/form-wizard.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/global/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js')); ?>" type="text/javascript"></script>
...
<!-- MultiSelect SCRIPTS -->
<script src="<?php echo e(asset('public/assets/global/plugins/fancybox/source/jquery.fancybox.pack.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('public/assets/pages/scripts/table-datatables-responsive.min.js')); ?>" type="text/javascript"></script>

<!--image cropper-->
<script src="<?php echo e(asset('public/js/cropper.js')); ?>" type="text/javascript"></script>
<!---- table fixer -->
<script src="<?php echo e(asset('public/js/tableHeadFixer.js')); ?>" type="text/javascript"></script>

<?php /**PATH C:\xampp\htdocs\oem\resources\views/layouts/default/footerScript.blade.php ENDPATH**/ ?>