...
<html lang="en">
    <head>
        ...
        <!-- start apex chart -->
        <link href="<?php echo e(asset('public/assets/layouts/layout/css/apex_styles.css')); ?>" rel="stylesheet" type="text/css" />
        <!-- end apex chart -->

    </head>
    <!-- END HEAD --><?php /**PATH C:\xampp\htdocs\oem\resources\views/layouts/default/header.blade.php ENDPATH**/ ?>