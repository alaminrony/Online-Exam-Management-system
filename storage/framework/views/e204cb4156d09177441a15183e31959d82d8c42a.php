...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-suitcase"></i><?php echo app('translator')->get('label.UPDATE_APPOINTMENT'); ?> </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo e(Form::model($appointment, array('route' => array('designation.update', $appointment->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'appointmentUpdate'))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/designation/edit.blade.php ENDPATH**/ ?>