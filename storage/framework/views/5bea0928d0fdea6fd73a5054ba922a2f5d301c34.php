...
<!--Gallery Js-->
<!--profile-->
<script src="<?php echo e(asset('public/css/gallery/js/modernizr.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/css/gallery/js/modules-combined.min.js')); ?>" type="text/javascript"></script>
<!--profile-->

<!--------Album----------->

<script src="<?php echo e(asset('public/assets/gallery/js/lightgallery-all.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH C:\xampp\htdocs\oem\resources\views/home/home_footer.blade.php ENDPATH**/ ?>