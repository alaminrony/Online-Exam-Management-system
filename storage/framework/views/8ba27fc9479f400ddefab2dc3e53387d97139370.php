...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i><?php echo app('translator')->get('label.CLUSTER_LIST'); ?>
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('cluster/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo app('translator')->get('label.CREATE_NEW_CLUSTER'); ?>
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                <?php echo Form::open(array('group' => 'form', 'url' => 'cluster/filter','class' => 'form-horizontal')); ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e(++$sl); ?></td>
                            <td><?php echo e($target->region); ?></td>
                            ...
                            <td>
                                <div class="text-center">
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('cluster/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <?php echo e(Form::open(array('url' => 'cluster/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline'))); ?>
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="9"><?php echo app('translator')->get('label.NO_CLUSTER_FOUND'); ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oem\resources\views/cluster/index.blade.php ENDPATH**/ ?>